  ...
  return (
    <div className="Landing">
      ...
      <div id="content-box" className = "flex inset-shadow-sm justify-center items-center flex-row">
        ...
        <img src={Placeholder} alt='Placeholder' className="w-[25%] rounded-bl-[60%] rounded-tl-[10%]"/>
      </div>
      <Separator />
      <div id="content-box" className = "flex justify-center items-center flex-row">
        <img src={Placeholder} alt='Placeholder' className="w-[25%] rounded-br-[60%] rounded-tr-[10%]"/>
